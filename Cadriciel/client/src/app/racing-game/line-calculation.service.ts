...
export class LineCalculationService {
    ...
    public getNearestPointOnLineWithClamping(point: THREE.Vector2, line: {point1: THREE.Vector2, point2: THREE.Vector2}): number {
    ...
    public getNearestPointOnLineWithoutClamping(point: THREE.Vector2, line: {point1: THREE.Vector2, point2: THREE.Vector2}) {
    ...
    public twoLineIntersection(line1, line2): THREE.Vector2 {
        if (line1.a === 0) {
